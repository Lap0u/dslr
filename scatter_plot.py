...
def scatter_plot(df, feat1, feat2):
    ...
    plt.scatter(df[df['Hogwarts House'] == 'Slytherin'][feat1], df[df['Hogwarts House']
                == 'Slytherin'][feat2], alpha=0.4, label="Slytherin", color="green")
    plt.scatter(df[df['Hogwarts House'] == 'Gryffindor'][feat1], df[df['Hogwarts House']
                == 'Gryffindor'][feat2], alpha=0.4, label="Gryffindor", color="red")
    plt.scatter(df[df['Hogwarts House'] == 'Ravenclaw'][feat1], df[df['Hogwarts House']
                == 'Ravenclaw'][feat2], alpha=0.4, label="Ravenclaw", color="cyan")
    plt.scatter(df[df['Hogwarts House'] == 'Hufflepuff'][feat1], df[df['Hogwarts House']
